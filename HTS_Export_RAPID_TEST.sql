...
(select distinct person_id,obs_datetime from obs where obs_datetime between cast('2024-03-18' as date) and cast('2024-03-19'  as date) and concept_id=2165 and voided=0) as b
...
INTO OUTFILE '/var/lib/mysql-files/xxx.csv'  FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
 LINES TERMINATED BY '\n';
